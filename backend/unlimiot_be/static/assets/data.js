var data = [
    {
      ...
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '34.83686739913989',
      lng: '126.12305337058872',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '34.7091954272817',
      lng: '125.92672218009464',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인3',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '34.691260753326894',
      lng: '126.90565134080038',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '35.64271889751915',
      lng: '126.60375442047945',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '35.25157445633953',
      lng: '127.22434280551657',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인4',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '34.75930733047455',
      lng: '127.19168025486954',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '35.07534116267619',
      lng: '126.76380089465971',
      img: '<img src="{% static "assets/images/restaurant/restaurant1.png" %}" >'
    },{
      title: '카페지인',
      partnership: '2잔 이상 구매시 10% 할인',
      lat: '34.82636520328515',
